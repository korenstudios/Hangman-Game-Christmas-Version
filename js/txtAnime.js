...
*/
              ...
              elmnt.forEach((el) => {
                ...
                function typedFuncOne() {
                  ...
                  function startEffect(start) {
                    ...
                    getSpan.innerHTML = getSpan.textContent.replace(
                      /\S/g,
                      `<span>$&</span>`
                    );

                    let getAllSpans = Array.from(
                      getSpan.querySelectorAll("span")
                    );
  ...
  \**********************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      /* harmony export */ TxtAnime: () =>
        /* reexport safe */ _js_TxtAnime__WEBPACK_IMPORTED_MODULE_1__.TxtAnime,
      /* harmony export */
    });
    /* harmony import */ var _main_scss__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(/*! ./main.scss */ "./src/main.scss");
    /* harmony import */ var _js_TxtAnime__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./js/TxtAnime */ "./src/js/TxtAnime.js");
